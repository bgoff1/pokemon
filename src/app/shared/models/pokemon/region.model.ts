import { enumKeys, enumValues } from '@util/enum/enum';
...
export const getRegionName = (regionName: keyof typeof Region): RegionName => {
  switch (regionName) {
    case 'Johto':
...
export const getRegion = (region: RegionName): Region => {
  switch (region) {
